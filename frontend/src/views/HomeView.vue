...
<template>
  ...
  <div class="max-w-7xl mx-auto grid grid-cols-1 gap-4 px-10">
...
<div class="max-w-7xl mx-auto grid grid-cols-1 gap-4">
    ...
    <div  class="grid grid-cols-3 gap-4">
        <div class="max-w-sm ">
            ...
            <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src="https://buffer.com/cdn-cgi/image/w=1000,fit=contain,q=90,f=auto/library/content/images/size/w600/2023/10/free-images.jpg" alt="">
    ...
    <div class="grid grid-cols-1 gap-4 collection">
